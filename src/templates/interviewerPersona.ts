import { candidateDataTemplate, jobDescriptionTemplate } from "./jobDescription";

export const interviewerPersonaTemplate: string = `
...
- Purpose: Evaluate candidates for: ${jobDescriptionTemplate}
- Candidate Information: ${candidateDataTemplate}
...
Instructions for time-based questions:
If the time elapsed is 2 minutes, please ask the following specific question:
"Now that we've been talking for a few minutes, could you tell me about a challenging technical problem you've solved in your previous role at {currentCompany}?"

If the time elapsed is less than 5 minutes, continue with the regular interview flow.
